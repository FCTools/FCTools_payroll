...
class Report(models.Model):
    ...
    profit_admin = models.DecimalField(verbose_name="ADMIN profit", null=False, blank=False, decimal_places=6,
                                       max_digits=13, )

    profit_native = models.DecimalField(verbose_name="NATIVE profit", null=False, decimal_places=6, max_digits=13, )

    profit_push = models.DecimalField(verbose_name="PUSH profit", null=False, blank=False, decimal_places=6,
                                      max_digits=13, )

    profit_pop = models.DecimalField(verbose_name="POP profit", null=False, blank=False, decimal_places=6,
                                     max_digits=13, )

    profit_fpa_hsa_pwa = models.DecimalField(verbose_name="FPA/HSA/PWA profit", null=False, decimal_places=6,
                                             max_digits=13, )

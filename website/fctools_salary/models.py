...
class User(models.Model):
    ...
    fpa_hsa_pwa_balance = models.DecimalField(
        verbose_name='FPA/HSA/PWA balance',
        null=True,
        blank=False,
        default=0,
        decimal_places=6,
...
class Campaign(models.Model):
    ...
    offers_list = models.ManyToManyField(
        Offer,
